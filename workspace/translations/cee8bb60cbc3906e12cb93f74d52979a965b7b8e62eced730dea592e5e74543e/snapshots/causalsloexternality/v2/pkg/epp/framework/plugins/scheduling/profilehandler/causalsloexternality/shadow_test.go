...
// prompt-only count under-states the KV a departure reclaims in
// rollforwardEstimateTAdm, which over-states tAdm, which enlarges the admission window, which
// gates more residents out of the externality -- under-pricing the local candidate.
