...
func (r *Runner) registerInTreePlugins() {
	...
	// scenario overlay: router.epp.flags renders as `--<key>=<value>` args on the epp
	// container (config/charts/routerlib/templates/_deployment.yaml:115-120, documented at
	// values.yaml:29-31), and the scenario's whole router block is passed through by
