...
func (r *Runner) registerInTreePlugins() {
	...
	// random-pd-decider -- the fixed-probability control arm. Specified at
	// algorithms/random_disagg.go in the pd-infocomm-3 bundle. Alpha: it is a
	// control for measurement, never a deployment candidate.
	fwkplugin.Register(disagg.RandomPDDeciderPluginType, fwkplugin.StabilityAlpha, disagg.RandomPDDeciderPluginFactory)
